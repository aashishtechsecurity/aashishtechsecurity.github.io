        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex gap-3 pt-6">
              <a href="https://www.instagram.com/aashish_tech_security" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="p-3 min-w-[44px] min-h-[44px] flex items-center justify-center bg-bg-card border border-border-glow rounded hover:bg-bg-card-hover hover:box-glow-cyan transition-all text-text-primary hover:text-accent-cyan active:scale-95"><Instagram className="w-5 h-5" /></a>
