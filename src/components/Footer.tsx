        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 text-center md:text-left">
          ...
          <div className="space-y-4 flex flex-col items-center md:items-start">
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/aashish_tech_security" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="p-3 min-w-[44px] min-h-[44px] flex items-center justify-center bg-bg-card border border-border-glow/30 rounded hover:border-accent-cyan hover:text-accent-cyan active:scale-95 transition-all"><Instagram className="w-5 h-5" /></a>
